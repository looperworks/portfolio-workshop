...
const MODULES = [
  {
    ...
    part: "Narrative",
    overview: `A portfolio is not a binder of coursework or a personal design journal. It is a constructed argument. Every decision about what to include, how to sequence it, and where to place it on the page is an act of design. The portfolio is not separate from your work; it is your work, reframed for an audience. And it speaks before you do. Before you walk into a review, an interview, or a scholarship committee, the sequencing of images, the hierarchy of information, and the clarity of layout have already made your case or lost it.

That case is read at two speeds. At skim speed (thirty seconds), the image hierarchy, cover, and sequencing must tell a story. At read speed (two to five minutes), the project statements, captions, and visual details must deepen that story without contradicting it.

Different audiences read for different evidence. An academic reviewer looks for sketches, diagrams, and dead ends that reveal how you think through a problem. A large firm looks for resolved, publication-quality deliverables that prove you can produce at a professional standard. A boutique studio looks for design sensibility and intellectual alignment, because they are hiring a collaborator, not a technician. Knowing what each audience evaluates for is the difference between a page that documents and a page that argues.

Every architecture portfolio shares a common anatomy: cover page, table of contents, project spreads, and supplemental material (resume, skills, contact). Within each project spread, four image types perform distinct roles: concept, process, outcome, and context. These categories and their sequencing logic are developed in Modules 2 and 3. For now, the key principle is this: once you can name the role each element plays, you stop arranging by habit and start composing by intent.`,
