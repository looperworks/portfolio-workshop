...
const MODULES = [
  {
    ...
    part: "Narrative",
    overview: `A portfolio is not a binder of coursework or a personal design journal. It is a constructed argument: every decision about what to include, how to sequence it, and where to place it on the page is an act of design. The portfolio is not separate from your work. It is your work, reframed for an audience. Before you walk into a review, an interview, or a scholarship committee, your portfolio has already made its case. Reviewers typically spend thirty seconds on an initial scan. In that window, the sequencing of images, the hierarchy of information, and the clarity of layout have either earned deeper attention or lost it.

A portfolio operates on two tracks simultaneously. At skim speed (thirty seconds), the image hierarchy, cover, and sequencing must tell a story. At read speed (two to five minutes), the project statements, captions, and visual details must deepen that story without contradicting it. The strongest portfolios hold up at both speeds because every element was placed with both readings in mind.

Different audiences read for different evidence. An academic reviewer prioritizes sketches, diagrams, and dead ends that reveal process depth, because their question is whether you can think through a problem. A professional reviewer at a large firm looks for resolved, publication-quality deliverables and technical range, because their question is whether you can produce at the standard their clients expect. A boutique studio values design sensibility and intellectual alignment, because they are hiring a collaborator, not just a technician. Knowing what each audience is evaluating for is the difference between a page that documents and a page that argues.

Every architecture portfolio shares a common anatomy: cover page (identity), table of contents (navigation), project spreads (the argument), and supplemental material (resume, skills, contact) to close. Within each project spread, four image types perform distinct roles: concept images establish the idea, process images show how it developed, outcome images present the resolved work, and context images situate it in a larger frame. Once you can name each role, you can sequence with purpose rather than habit.`,
